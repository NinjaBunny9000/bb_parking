...
--- possible lots found but not added across from 1105, 1040, 1080, 3051, 5011, 5033(plaza), 5061, 7004, 8170, 9110(mall), 10025(ungated airport lot)
...
--Name: publicLot 1017- cam 4/22/21
-- many more spaces to add
Zones.publicLot1017 =  PolyZone:Create({
    vector2(90.533653259277,6427.0380859375),
    vector2(66.774284362793,6417.93359375),
    vector2(-25.751518249512,6324.486328125),
    vector2(-10.37056350708,6301.9790039062),
    vector2(56.281826019287,6341.4770507812),
    vector2(69.509429931641,6354.6557617188),
    vector2(115.49156951904,6377.1176757812)
}, {
    name="publicLot1017",
...
ZoneProperties.publicLot1017 = {
    label = 'Public Parking Lot #1017',
    showBlip = true,
    blipCoords = vector3(80.742645263672,6423.1064453125,31.647350311279),
    public = true,
    ...
    parkingSpots = { --  parking spots
        ...
        -- row 1 (perpendicular to entrance road)
        {vector3(80.723167419434,6395.7138671875,30.853605270386), 313.62},
        {vector3(77.87784576416,6398.3715820312,30.854331970215), 313.62},
        {vector3(75.04222869873,6400.98046875,30.853755950928), 313.62},
        {vector3(72.101234436035,6403.859375,30.853591918945), 313.62},

        -- row 2 (opposite side of lot from row 1)
        {vector3(7.5014533996582,6320.2016601562,30.859222412109), 196.78},
        {vector3(10.9480676651,6321.6831054688,30.85870552063), 196.78},
        {vector3(14.304696083069,6323.9467773438,30.858842849731), 196.78},
        {vector3(17.5433177948,6326.1059570312,30.859451293945), 196.78}
    }
}


--Name: publicLot 3051- cam 4/22/21
-- small 3 car gas station lot (only thing around right now)
Zones.publicLot3051 =  PolyZone:Create({
    vector2(2665.7385253906,3252.9780273438),
    vector2(2669.28515625,3260.1123046875),
    vector2(2658.7863769531,3265.9567871094),
    vector2(2655.0314941406,3259.3232421875)
}, {
    name="publicLot3051",
    debugPoly = Config.DEBUG,
    --minZ = 51.56,
...
ZoneProperties.publicLot3051 = {
    label = 'Public Parking Lot #3051',
    showBlip = true,
    blipCoords = vector3(2665.7385253906,3252.9780273438,55.240501403809),
    public = true,
    pricePerHour = 100, -- IRL hours, in-game currency
    parkingCardAccepted = ParkingCards.DemoCard,
    hideParkedCars = true,
    parkingSpots = { --  parking spots
        ...
        -- row 1
        {vector3(2658.9243164062,3261.3811035156,54.868259429932), 330.62},
        {vector3(2662.3918457031,3259.6193847656,54.868427276611), 330.62},
        {vector3(2665.8049316406,3257.7937011719,54.868026733398), 330.62},
    }
}
...
--Name: publicLot 8037 | 2021-04-11T06:40:56Z
